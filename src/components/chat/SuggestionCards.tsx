          ...
          {suggestions.map((suggestion, index) => {
            ...
            return (
              <button
                ...
                className="group relative overflow-hidden p-3.5 sm:p-4 rounded-2xl border border-gray-100 bg-white hover:border-gray-200 transition-all duration-300 hover:shadow-lg text-left press-effect"
                style={{
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`w-10 h-10 rounded-xl ${suggestion.bgLight} flex items-center justify-center mb-3 transition-all duration-300 group-hover:scale-110 group-hover:${suggestion.hoverBg}`}
                >
                  <Icon className={`w-5 h-5 ${suggestion.textColor} transition-transform duration-300 group-hover:rotate-[-8deg]`} />
                </div>

                {/* Text */}
                <h4 className="text-sm font-semibold text-gray-800 mb-0.5 group-hover:text-gray-900 transition-colors">
                  {suggestion.title}
                </h4>
                ...
                {/* Arrow indicator */}
                <div className={`absolute bottom-3 right-3 w-5 h-5 rounded-full ${suggestion.bgLight} flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0`}>
